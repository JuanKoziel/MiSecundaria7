...
| `jefe_preceptores` | Jefe de Preceptores | fa-users-cog | Supervisión preceptores, estadísticas, asignación cursos, admin preceptores, comunicados jefe, actas, notas, asistencias, alumnos, docentes, tutores, adelantos horas, calendario, historial |
| `preceptor` | Preceptor | fa-clipboard-user | Gestión diaria: alumnos, tutores, docentes, asistencias (día/materia/docentes), notas/boletines, actas, libro temas, proyectos, actividades, adelantos horas, horarios, comunicados, notificaciones, calendario |
| `docente` | Docente | fa-chalkboard-teacher | Panel docente, planificaciones, libro temas, info, asistencia, actividades, actas docente, alumnos, comunicados, notificaciones, diagnóstico, calendario, materias adeudadas |
| `familia` | Familia | fa-users | Resumen, calificaciones/boletín PDF, asistencias, actas, comunicados, horarios, actividades, info, notificaciones (personales/por hijo), calendario |
| `alumno` | Estudiante | fa-user-graduate | Perfil, calificaciones/boletín PDF, asistencias, materias adeudadas (intensificaciones/previas), horario, comunicados, notificaciones, info, calendario |
...
|---------|-------------|---------------|-----------|
| **Alumno** | `id_alumno`, `dni`, `nombre`, `apellido`, `curso`, `id_curso`, `id_tutor`, `id_usuario`, `fecha_nacimiento`, `direccion`, `telefono`, `procedencia`, `usuario`, `usuario_estado` | `/alumnos/` | Todos |
...
| **Curso** | `id_curso`, `nombre_curso` (ej: "4°1"), `orientacion`, `id_preceptor`, `id_ciclo`, `activo`, `ciclo_anio` | `/cursos/` | Admin, Preceptor, Docente, Familia, Alumno |
...
| **Registro Rendiciones Previas** | Historial de rendiciones de previas por alumno/materia | `/registro-rendiciones-previas/` |
...
|----|---------------|----------------|-----|
| RF-ASIST-01 | Asistencia por día (curso): lista alumnos, estados (Presente/Ausente/Tarde/Retirado), guardar batch | `Preceptores/asistencias.jsx:290-340`, `api.js:269-272` | Preceptor |
| RF-ASIST-02 | Asistencia por materia (visualización): filtros materia/fecha/alumno, justificación | `Preceptores/asistencias.jsx:410-556`, `api.js:252-257, 259-262` | Preceptor |
...
| RF-ASIST-07 | Historial / Registro diario por curso/alumno/fecha | `Preceptores/asistencias.jsx:339-406`, `api.js:291-296` | Preceptor, Admin |
| RF-ASIST-08 | Vista unificada alumno/familia: resumen 7 días, por materia, detalle con combinación de estados (Ausente+Ausente=Ausente, Presente+Presente=Presente, Ausente+Presente=Tarde, Presente+Ausente=Retirado) | `Shared/AsistenciasUnificada.jsx:41-60, 83-145` | Alumno, Familia, Preceptor (readOnly) |
| RF-ASIST-09 | Estados de asistencia configurables | `api.js:274-277` | Admin |

### 4.5 Calificaciones y Boletines (RF-CALIF)

| ID | Requerimiento | Implementación | Rol |
|----|---------------|----------------|-----|
| RF-CALIF-01 | Carga de calificaciones por Curso-Materia-Período (pre-nota, nota, diagnóstico) | `Profesores/PanelActividades.jsx` (actividades), `Preceptores/notas.jsx` (vista boletines), `api.js:218-236` | Docente, Preceptor |
| RF-CALIF-02 | Guardado en batch (múltiples alumnos una sola request) | `api.js:233-236` `guardarCalificacionesBatch` | Docente, Preceptor |
| RF-CALIF-03 | Períodos: 1 (1er cuatri), 2 (2do cuatri) → prenota1/nota1, prenota2/nota2 | `DataContext.jsx:433-469`, `utils/boletin.js:17-22` | Todos |
| RF-CALIF-04 | Diagnóstico grupal por materia/curso | `DataContext.jsx:622-634`, `api.js:480-488` | Docente, Preceptor |
| RF-CALIF-05 | Boletín consolidado por alumno: tabla principal + previas + recursadas + intensificaciones (1er cuatri, dic, feb) | `utils/boletin.js:161-240`, `components/BoletinTablaPrincipal.jsx`, `BoletinExtras.jsx` | Preceptor, Familia, Alumno |
| RF-CALIF-06 | Exportación boletín PDF (ventana impresión, CSS @page A4) | `utils/boletin.js:320-329`, `Familia/Calificaciones.jsx:88-104` | Preceptor, Familia, Alumno |
| RF-CALIF-07 | Intensificaciones 1er cuatrimestre, diciembre, febrero | `utils/boletin.js:24-52`, `hooks/useBoletinAcademico.js` | Preceptor, Familia, Alumno |
| RF-CALIF-08 | Materias adeudadas / recursadas / previas con estado y notas | `Alumno/PanelMateriasAdeudadasAlumno.jsx`, `api.js:768-800` | Alumno, Familia, Docente (PanelMateriasAdeudadasDocente) |
| RF-CALIF-09 | Bloqueo de materias por intensificación | `utils/boletin.js:32-34` `bloqueos_por_materia` | Preceptor, Familia, Alumno |
...
| ID | Requerimiento | Implementación | Rol |
|----|---------------|----------------|-----|
| RF-ACTA-01 | Tipos de acta: Alumno, Docente, Curso (resuelve tipo "Evaluación" por defecto) | `Preceptores/actas.jsx:31-43`, `api.js:331-334` | Preceptor, Docente, Jefe, Admin |
...
| RF-ACTA-05 | Filtros año/curso, agrupación por alumno/docente/curso, colapsables | `Preceptores/actas.jsx:470-665` | Preceptor, Jefe, Admin |
| RF-ACTA-06 | Vista solo lectura para Familia/Alumno (actas del alumno) | `Familia/Actas.jsx`, `AlumnoDashboard.jsx` (no hay vista actas en alumno) | Familia |
...
| RF-COM-02 | Filtrado por alcance para Familia/Alumno (parsea curso → año/división, matchea alcances) | `Familia/Comunicados.jsx:4-18`, `utils/orientacion.js` | Familia, Alumno |
| RF-COM-03 | Vista compartida `ComunicadosView` reutilizable por rol | `Shared/ComunicadosView.jsx` | Preceptor, Jefe, Docente, Familia, Alumno |
...
| RF-PLAN-05 | Vista de diagnóstico grupal por curso | `Shared/DiagnosticosView.jsx`, `api.js:480-488` | Docente, Preceptor, Jefe, Admin, Familia, Alumno |
...
| RF-HOR-03 | Vista horarios por curso (solo lectura) para Familia/Alumno/Preceptor | `Administracion/VistaHorarios.jsx`, `FamiliaDashboard.jsx:104-115`, `AlumnoDashboard.jsx:215-220` | Familia, Alumno, Preceptor |
...
|----|---------------|---------------------|
| RNF-01 | **Responsive / Mobile-first** para Familia y Alumno (header compacto, sidebar colapsable, tablas scroll) | `FamiliaDashboard.jsx`, `AlumnoDashboard.jsx`, `VISUAL_STANDARD.md` |
...
| RNF-09 | **Internacionalización parcial** (es-AR: fechas, números, moneda) | `utils/boletin.js:174`, `utils/orientacion.js`, `Shared/AsistenciasUnificada.jsx:22-32` |
...
| RNF-13 | **Firma digital / Validez legal de PDFs NO implementado** (boletines, actas) | Gap legal identificado |
...
| RN-11 | **Boletín PDF**: 2 páginas (p1: materias regulares + intensificaciones; p2: previas + recursadas), firma y sello | `utils/boletin.js:176-239` |
...
3. Tab "Asistencia por día" → Lista alumnos del curso con botones de estado
4. Click estados → Click "Guardar" → Batch `createAsistencia` por alumno
...
3. Para notas formales: Preceptor usa "Notas" → Boletines por alumno → Exporta PDF
...
### 7.5 Familia: Consulta Boletín e Historial
...
3. Botón "Descargar boletín PDF" → Ventana impresión → Guarda/Imprime
...
### 7.6 Alumno: Autogestión Académica
...
| `AsistenciasUnificada` | `alumnoId`, `cursoMateria`, `idCurso`, `userRole` | Familia, Alumno, Preceptor (readOnly) |
| `ComunicadosView` | `userRole`, `cursoSeleccionado`, `materiaSeleccionada`, `selectedChild` | Preceptor, Jefe, Docente, Familia, Alumno |
| `DiagnosticosView` | `userRole`, `cursoSeleccionado`, `cursosEditables`, `selectedChild` | Todos |
| `ActividadesView` | `userRole`, `cursoId`, `cursoNombre`, `selectedChild` | Preceptor, Familia, Alumno |
| `BoletinTablaPrincipal` / `BoletinExtras` | `materias`, `intensificaciones_1c`, `bloqueos_por_materia`, `intensificaciones_posteriores`, `recursadas`, `previas`, `loading` | Preceptor, Familia, Alumno |
| `VistaHorarios` | `cursosOptions`, `cursoForzado`, `mostrarTitulo` | Familia, Alumno, Preceptor |
...
| `SidebarToggle` | — | Alumno (hamburger mobile) |
...
| `utils/boletin.js` | `boletinHTML`, `exportarBoletinPDF`, `BOLETIN_CSS` | Generación HTML+CSS boletín oficial 2 páginas |
...
| `utils/intensificaciones.js` | Lógica intensificaciones | Apoyo boletín |
| `hooks/useBoletinAcademico.js` | `intensificaciones_1c`, `bloqueos_por_materia`, `intensificaciones_posteriores`, `recursadas`, `previas`, `loading` | Hook unificado datos boletín académico |
...
| **PWA** | No manifest, no install prompt, no push nativo | Familia/Alumno usan web, no "app" |
| **Firma Digital** | Boletines y actas PDF sin firma digital ni código de verificación | Validez legal cuestionable |
...
| **Migración Datos** | No hay scripts/endpoint de importación masiva (Excel/CSV) para alumnos, docentes, notas históricas | Puesta en producción requiere carga manual |
...
- [ ] Notas: ve boletines por alumno, exporta PDF individual
...
- [ ] Alumnos/Info: ve lista, datos
- [ ] Materias Adeudadas: ve panel alumnos con deudas
...
- [ ] Hereda vistas preceptor (alumnos, docentes, tutores, asistencias, actas, notas) en readOnly

### 12.5 Admin / Director
- [ ] Usuarios: CRUD docentes, preceptores, administradores, alumnos
...
| `id_usuario` | int|null | FK Usuario (para login alumno) |
...
| `id_alumno` | int|null | Alumno relacionado (null = personal familia) |
...
| **v1.2** | +Calificaciones | Batch, boletín PDF 2 páginas, intensificaciones, previas, recursadas |
...
2. **Firma Digital**: Integración certificados (PKI) para boletines y actas con validez legal
...
9. **Integración SGA Provincial**: API documentada para sincronizar alumnos, notas, asistencias
10. **App Móvil Nativa** (React Native / Capacitor) para Familia/Alumno/Preceptor en patio
